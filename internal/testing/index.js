/*
 Stencil Testing Platform v0.0.0-dev.20200508114528 | MIT Licensed | https://stenciljs.com
 */
'use strict';
...
const bootstrapLazy = (lazyBundles, options = {}) => {
    ...
    lazyBundles.map(lazyBundle => lazyBundle[1].map(compactMeta => {
        ...
        const tagName = appData.BUILD.transformTagName && options.transformTagName ? options.transformTagName(cmpMeta.$tagName$) : cmpMeta.$tagName$;
