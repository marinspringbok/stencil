    ...
    function transform() {
        return () => {
            return (tsSourceFile) => {
                ...
                return typescript_1.default.updateSourceFileNode(tsSourceFile, [...letNoInitializerStatements, ...letWithInitializer, ...importStatements, ...otherStatements, ...exportStatements]);
            };
        };
    }
    function isLet(n) {
