...
import { HTML_NS, SVG_NS, isDef } from '@utils';
...
export const isSameVnode = (vnode1, vnode2) => {
...
export const callNodeRefs = (vNode) => {
    if (BUILD.vdomRef) {
        vNode.$attrs$ && vNode.$attrs$.ref && vNode.$attrs$.ref(null);
        vNode.$children$ && vNode.$children$.map(callNodeRefs);
    }
};
export const renderVdom = (hostRef, renderFnResults) => {
