...
export function setupGlobal(gbl) {
    if (gbl.window == null) {
...
export function teardownGlobal(gbl) {
    const win = gbl.window;
    if (win && typeof win.close === 'function') {
        win.close();
    }
}
export function patchWindow(winToBePatched) {
...
export function addGlobalsToWindowPrototype(mockWinPrototype) {
