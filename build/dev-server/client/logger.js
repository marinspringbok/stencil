export const logBuild = (msg) => log(BLUE, 'Build', msg);
export const logReload = (msg) => logWarn('Reload', msg);
export const logWarn = (prefix, msg) => log(YELLOW, prefix, msg);
export const logDisabled = (prefix, msg) => log(GRAY, prefix, msg);
export const logDiagnostic = (diag) => {
