...
export const listenDecoratorsToStatic = (diagnostics, decoratedMembers, newMembers) => {
...
export const parseListener = (diagnostics, eventName, opts = {}, methodName, decoratorNode) => {
...
export const isValidTargetValue = (prefix) => {
    return VALID_ELEMENT_REF_PREFIXES.has(prefix);
};
export const isValidKeycodeSuffix = (prefix) => {
