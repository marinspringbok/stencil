...
export const coreResolvePlugin = (config, compilerCtx, platform) => {
    if (platform === 'worker') {
        return {
...
export const getStencilInternalModule = (rootDir, compilerExe, internalModule) => {
    if (isExternalUrl(compilerExe)) {
...
export const getHydratedFlagHead = (h) => {
