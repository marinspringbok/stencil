...
export const generateServiceWorker = async (config, buildCtx, workbox, outputTarget) => {
...
export const hasServiceWorkerChanges = (config, buildCtx) => {
...
export const getRegisterSW = (swUrl) => {
    return `
