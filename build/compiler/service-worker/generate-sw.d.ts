...
export declare const generateServiceWorker: (config: d.Config, buildCtx: d.BuildCtx, workbox: d.Workbox, outputTarget: d.OutputTargetWww) => Promise<void | [void, void]>;
export declare const hasServiceWorkerChanges: (config: d.Config, buildCtx: d.BuildCtx) => boolean;
