export const getStyleId = (cmp, modeName, isScopedStyles) => {
    return `${cmp.tagName}${modeName}${isScopedStyles ? '.sc' : ''}`;
};
export const escapeCssForJs = (style) => {
...
export const requiresScopedStyles = (encapsulation, commentOriginalSelector) => {
...
export const stripCssComments = (input) => {
