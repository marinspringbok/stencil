...
export const validateBuildPackageJson = async (config, compilerCtx, buildCtx) => {
    if (config.watch) {
        return;
    }
...
export const validatePackageFiles = async (config, compilerCtx, buildCtx, outputTarget) => {
...
export const validateMain = (config, compilerCtx, buildCtx, outputTarget) => {
...
export const validateModule = (config, compilerCtx, buildCtx, outputTarget) => {
...
export const validateTypes = async (config, compilerCtx, buildCtx, outputTarget) => {
...
export const validateCollection = (config, compilerCtx, buildCtx, outputTarget) => {
...
export const validateBrowser = (config, compilerCtx, buildCtx) => {
