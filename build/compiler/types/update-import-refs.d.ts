 ...
 */
export declare const updateReferenceTypeImports: (importDataObj: d.TypesImportData, allTypes: Map<string, number>, cmp: d.ComponentCompilerMeta, filePath: string) => d.TypesImportData;
