...
export async function inlineExternalStyleSheets(appDir, doc) {
...
export async function minifyScriptElements(doc) {
...
export async function minifyStyleElements(doc) {
    const { optimizeCss } = await import('@stencil/core/compiler');
...
export function addModulePreloads(doc, hydrateResults, componentGraph) {
    if (!componentGraph) {
        return false;
    }
