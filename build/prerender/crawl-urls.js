...
export function crawlAnchorsForNextUrls(prerenderConfig, diagnostics, baseUrl, currentUrl, parsedAnchors) {
...
export function standardNormalizeHref(prerenderConfig, diagnostics, url) {
    try {
