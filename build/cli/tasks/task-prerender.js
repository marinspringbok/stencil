...
export async function taskPrerender(prcs, config) {
...
export async function runPrerenderTask(prcs, config, devServer, hydrateAppFilePath, componentGraph, srcIndexHtmlPath) {
