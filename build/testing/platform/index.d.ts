...
export { Context, isMemberInElement, plt, supportsShadow, registerComponents, registerContext, registerModule, resetPlatform, startAutoApplyChanges, stopAutoApplyChanges, supportsConstructibleStylesheets, supportsListenerOptions, setSupportsShadowDom, } from './testing-platform';
