export function toEqualAttribute(elm, expectAttrName, expectAttrValue) {
    if (!elm) {
...
export function toEqualAttributes(elm, expectAttrs) {
    if (!elm) {
...
export function toHaveAttribute(elm, expectAttrName) {
    if (!elm) {
